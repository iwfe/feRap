<template>
  <div class="update-prd-wrap">
    <el-button type="primary" @click="handleAdd" icon="plus" size="small">编辑</el-button>
    <el-dialog
      title="编辑PRD"
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="JIRA地址" prop="jiraAddr">
          <el-input type="text" v-model="form.jiraAddr"></el-input>
        </el-form-item>
        <el-form-item label="提测时间" prop="testTime">
          <el-input type="text" v-model="form.testTime"></el-input>
        </el-form-item>
        <el-form-item label="上线时间" prop="onLineTime">
          <el-input type="text" v-model="form.onLineTime"></el-input>
        </el-form-item>
        <el-form-item label="是否合master" prop="mergedMaster">
          <el-switch
            v-model="form.mergedMaster"
            on-text="是"
            off-text="否"
            on-color="#13ce66"
            off-color="#ff4949"
